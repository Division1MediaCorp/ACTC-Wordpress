...
function citygov_register_sidebars() {
	...
	register_sidebar(array('name' => esc_html__( 'Sidebar','citygov' ),'id' => 'tmnf-sidebar','description' => esc_html__( 'Sidebar widget section','citygov' ),'before_widget' => '<div class="sidebar_item">','after_widget' => '</div>','before_title' => '<h2 class="widget dekoline">','after_title' => '</h2>'));
	

	//footer widgets
	register_sidebar(array('name' => esc_html__( 'Footer 1','citygov' ),'id' => 'tmnf-footer-1','description' => esc_html__( 'Widget section in footer - left','citygov' ),'before_widget' => '','after_widget' => '','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	register_sidebar(array('name' => esc_html__( 'Footer 2','citygov' ),'id' => 'tmnf-footer-2','description' => esc_html__( 'Widget section in footer - center/left','citygov' ),'before_widget' => '','after_widget' => '','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	register_sidebar(array('name' => esc_html__( 'Footer 3','citygov' ),'id' => 'tmnf-footer-3','description' => esc_html__( 'Widget section in footer - center/right','citygov' ),'before_widget' => '','after_widget' => '','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	register_sidebar(array('name' => esc_html__( 'Footer 4','citygov' ),'id' => 'tmnf-footer-4','description' => esc_html__( 'Widget section in footer - right','citygov' ),'before_widget' => '','after_widget' => '','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	...
	//free widget
	register_sidebar(array('name' => esc_html__( 'Free 1','citygov' ),'id' => 'tmnf-sidebar-free-1','description' => esc_html__( 'Free widget section','citygov' ),'before_widget' => '<div class="sidebar_item">','after_widget' => '</div>','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	
	register_sidebar(array('name' => esc_html__( 'Free 2','citygov' ),'id' => 'tmnf-sidebar-free-2','description' => esc_html__( 'Free widget section','citygov' ),'before_widget' => '<div class="sidebar_item">','after_widget' => '</div>','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	
	register_sidebar(array('name' => esc_html__( 'Free 3','citygov' ),'id' => 'tmnf-sidebar-free-3','description' => esc_html__( 'Free widget section','citygov' ),'before_widget' => '<div class="sidebar_item">','after_widget' => '</div>','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
	
	register_sidebar(array('name' => esc_html__( 'Free 4','citygov' ),'id' => 'tmnf-sidebar-free-4','description' => esc_html__( 'Free widget section','citygov' ),'before_widget' => '<div class="sidebar_item">','after_widget' => '</div>','before_title' => '<h2 class="widget dekoline dekoline_small">','after_title' => '</h2>'));
...
function citygov_register_required_plugins() {
    ...
    $plugins = array(
		...
		// shortcodes-ultimate
        array(
            'name'				=> esc_html__( 'Shortcodes Ultimate','citygov' ),
...
if ( ! function_exists ( 'citygov_meta_more' ) ) {
	function citygov_meta_more() { ?>   
		<a class="read_more" href="<?php citygov_permalink() ?>"><?php esc_html_e('Read More','citygov');?> &rarr; <span class="screen-reader-text"><?php the_title_attribute(); ?></span></a>
	<?php }
}
...
if ( ! function_exists ( 'citygov_breadcrumbs' ) ) {
	function citygov_breadcrumbs() {
	 ...
	 ";
			...
			echo '<span class="crumb">';
				$themnific_redux = get_option( 'themnific_redux' );
				if(empty($themnific_redux['tmnf-events-url'])) {echo esc_html__('Events','idence');} else {
					echo '<a href="'. esc_url($themnific_redux['tmnf-events-url']).'">';
					echo esc_html__('Events','idence');
					echo '</a>';
				}
			echo '</span>';
			}
