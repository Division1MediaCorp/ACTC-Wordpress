                    ...
                    <div>
                        ...
                        <?php
                            if ( $this->theme->parent() ) {
                                printf( ' <p class="howto">' . esc_html__( 'This <a href="%1$s">child theme</a> requires its parent theme, %2$s.','citygov' ) . '</p>', esc_html__( 'http://codex.wordpress.org/Child_Themes','citygov' ), $this->theme->parent()->display( 'Name' ) );
                            }
                        ?>
                    ...
                    'fields' => array( // header end
                        ...
                        array(
                      	...
                      	array(
                            ...
                            'options'  => array(
                                'tmnf_width_normal' => esc_html__('Normal (1140px)','citygov'),
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array( // header end
						...
						array(
                            ...
                            'google'      => true,
                            'font-backup' => true,
                            'output'      => array( 'h4,.tptn_posts_widget li::before,.sidebar_item .menu>li>a' ),
                            'units'       => 'px',
                            'line-height' => false,
						...
						array(
                            'id'          => 'citygov-h5',
                            'type'        => 'typography',
                            'title'       => esc_html__( 'H5 Font Style + Buttons','citygov' ),
                            'google'      => true,
                            'font-backup' => true,
                            'output'      => array( 'h5,.comment-author cite,.tab-post h4,.tptn_title,.submit,.nav-previous a,#comments .reply a,.post-pagination,.mc4wp-form input,.woocommerce #respond input#submit, .woocommerce a.button,.woocommerce button.button, .woocommerce input.button,.tmnf_events_widget a,.post-nav-text,a.event_button,.give-btn' ),
                            'units'       => 'px',
                            'line-height' => false,
                ...
                $this->sections[] = array(
                    ...
                    'fields' => array( // header end
						...
						array(
							...
							'default'   => '#fff',
							'output'    => array(
								'color' => 'a.searchSubmit,.ribbon,.ribbon a,.ribbon p,#footer .ribbon,.cat_nr,.woocommerce #respond input#submit,.woocommerce a.button.alt,.woocommerce input.button.alt,.woocommerce a.button,.woocommerce button.button.alt, .woocommerce button.button, .woocommerce input.button,#comments .reply a,#respond #submit,#footer a.mainbutton,a.mainbutton,.tmnf_icon,a.mainbutton,#submit,#comments .navigation a,.tagssingle a,.mc4wp-form input[type="submit"],a.comment-reply-link,.page-numbers.current,.meta_more a,.owl-next:before,.owl-prev:before,.page-link>span,.button_div input,button.give-btn-reveal,.give-btn-modal,.give-submit.give-btn',
							)
						),
          ...
          $this->sections[] = array(
                    ...
                    'fields' => array( // header end
                        ...
                        array(
                            ...
                            'type'     => 'text',
                            'title'    => esc_html__( 'Google+','citygov'),
                            'subtitle' => esc_html__( 'Enter full URL','citygov'),
                            'validate' => 'url',
                        ),
                        ...
                        array(
                            ...
                            'type'     => 'text',
                            'title'    => esc_html__( 'You Tube','citygov'),
                            'subtitle' => esc_html__( 'Enter full URL','citygov'),
                            'validate' => 'url',
                        ),
            ...
            public function setArguments() {
                ...
                $this->args['admin_bar_links'][] = array(
                    //'id'    => 'redux-support',
                    'href'   => 'http://capethemes.com/docs/citygov',
					'target'   => '_blank',
                ...
                $this->args['share_icons'][] = array(
                    'url'   => 'http://capethemes.com/docs/citygov',
					'target'   => '_blank',
                    'title' => esc_html__( 'Documentation', 'citygov' ),
